...
import {
  HttpMethod, AuthorizedHttpClient, HttpRequestConfig, HttpError, HttpResponse, RequestResponseError,
...
export class FirebaseMessagingRequestHandler {
   ...
   */
  public async invokeHttpRequestHandlerForSendResponse(host: string, path: string, requestData: object
    ...
    try {
      ...
      throw err; // Re-throw the error if it already has the proper format.
    }
  }
